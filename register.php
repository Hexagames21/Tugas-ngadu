                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Silahkan Masukan Biodata dengan Bnear!</h1>
                                    </div>
                                    <form class="user" method="post" action="proses-register.php">
                                        ...
                                        <div class="form-group">
                                            <input required name="nama" type="text" class="form-control form-control-user"
                                                id="exampleInputEmail" aria-describedby="emailHelp"
                                        ...
                                        <div class="form-group">
                                            <input required name="telp" type="text" class="form-control form-control-user"
                                                id="exampleInputEmail" aria-describedby="emailHelp"
                                        ...
                                        <a href="index.php" class="btn btn-google btn-user btn-block">
                                            <i class="fa fa-laptop fa-fw"></i> Sudah Punya Akun..? Silahkan Login Disini
                                        </a>
                                    </form>
                                </div>
                            </div>
